    ...
    <PageWrapper>
      <main className="container mx-auto py-12">
        <div className="text-center mb-12">
          <h1 className="font-headline text-4xl md:text-5xl tracking-wide">Emity Network</h1>
          <p className="text-muted-foreground mt-2">Internal tools and collaboration hub.</p>
        </div>
